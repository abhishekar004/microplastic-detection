...
- **Production Ready**: Configured for deployment on Hugging Face Spaces and Vercel
...
- **Hugging Face Spaces** - Backend API (Python/FastAPI)
...
6. The Space will automatically build and deploy your FastAPI backend
7. Copy your Hugging Face Space URL (e.g., `https://your-username-microplastic-detection.hf.space`)

**Note**: Hugging Face Spaces provides free GPU/CPU resources and is ideal for ML model deployment.

#### 3. Deploy Frontend to Vercel

1. Go to [vercel.com](https://vercel.com) and import your repository
2. Set root directory to `frontend`
3. Add environment variable: `VITE_API_BASE_URL` = your Hugging Face Space URL
4. Deploy

#### 4. Update CORS

1. Go back to Hugging Face Spaces
2. Update `CORS_ORIGINS` environment variable with your Vercel URL
3. The Space will automatically redeploy
...
- Review deployment logs in Hugging Face Spaces/Vercel dashboards
