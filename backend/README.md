...
7. The Space will automatically build and deploy your FastAPI backend
8. Your API will be available at: `https://your-username-microplastic-detection.hf.space`
